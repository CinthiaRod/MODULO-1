...
//Quiero que se familiaricen con la sintaxis del mismo, por lo que no hare énfasis en los datos, 
//sino en la solución.
//Dada la siguiente lista:
//Utilizar el algoritmo de búsqueda binaria para responder los siguientes ítems:
//¿Cuál es la posición del número 1?
//¿Cuál es la posición del número 5?o
//¿Cuál es la posición del número 6?
//¿Cuál es la posición del número 9?
//¿Cuál es la posición del número 11?
//Sabemos que responder estas preguntas es extremadamente fácil, ya que podemos leer el array, y
//determinar con un cálculo visual la posición de cada elemento, pero, 
